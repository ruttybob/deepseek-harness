...
description: >
  ...
  Writes structured output to a state file or issue board.
user_invocable: true
---
...
- Open issues / tracker tickets assigned to the team
...
A repo may pin exact sources and commands in `loop-constraints.md` — those pins override this generic list.
