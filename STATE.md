...
- Master mid-integration: 0.1.5-alpha.1 + session-log V3 merges landed within 48h (ed58a0933f, 2e0ef3b12f, 5dda764ed3) — expect migration/CI churn in next runs.
...
- Commit 2c21c7a03e "ci: 1" — stray commit message, no action.
