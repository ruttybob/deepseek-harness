...
pnpm run build          # tsc emits lib/types, tsdown bundles runtime; client-package edits also need `pnpm run build:lib:client` before dsh/web launch (stale-bundle guard)
