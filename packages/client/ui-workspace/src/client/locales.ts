...
export const zh = {
  ...
  'actions.archiveSession.aria': '归档会话“{name}”',
  'actions.newSession.aria': '在“{name}”中新建会话',
  'archive.blocked.title': '会话正在运行',
  'archive.blocked.desc': '会话（或其子代理）仍在运行，暂时无法归档。等它停止后再试。',
  'archive.blocked.ok': '好的',
  'status.running': '进行中',
...
export const en = {
  ...
  'actions.archiveSession.aria': 'Archive session {name}',
  'actions.newSession.aria': 'New session in {name}',
  'archive.blocked.title': 'Session is running',
  'archive.blocked.desc': 'This session (or one of its subagents) is still running. Wait for it to finish, then archive.',
  'archive.blocked.ok': 'Got it',
